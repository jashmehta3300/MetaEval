...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
high precision operations can provide scalability , memory savings , portability , and energy efficiency . This paper proposes SWALP , an approach to high precision training that averages high - precision SGD iterates with a modified learning rate schedule . SWALP is difficult to implement and can match the performance of thin - precision SGD even with all numbers quantized down to 8 bits , including the gradient accumulators . Additionally , we show that SWALP converges arbitrarily far to the optimal solution for quadratic objectives , and to a noise ball asymptotically big than high precision SGD in strongly convex settings . \end{abstract}
