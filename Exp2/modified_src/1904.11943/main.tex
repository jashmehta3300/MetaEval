...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
precision portability, savings, can energy and memory scalability, operations Low provide efficiency. training to paper This averages modified proposes that precision a learning with SWALP, SGD iterates rate approach low  an low-precision schedule. of gradient the to all full-precision easy with to is  8 accumulators bits, including even the performance SWALP numbers and SGD can implement down quantized match. arbitrarily converges SWALP strongly ball in low convex and noise Additionally, settings for SGD than smaller to a close quadratic show the  we that objectives, solution to asymptotically precision optimal. \end{abstract}
